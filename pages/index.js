  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-200 to-yellow-100 flex flex-col items-center justify-center p-4 text-center">
      ...
      <div className="relative mb-6">
        <svg viewBox="0 0 300 300" width="300" height="300" style={{ transform: `rotate(${rotation}deg)`, transition: "transform 3s ease-out" }}>
          <path d="M150,150 L150,10 A140,140 0 1,1 149.99,10 Z" fill={sliceColors[0]} />
          <text x="150" y="100" textAnchor="middle" fontSize="12" fill="#000">
            Fine, you can text your ex 🙈
          </text>
        </svg>
      ...
      <button onClick={handleSpin} disabled={spinning} className="mb-4 bg-white border px-4 py-2 rounded-md shadow-md">
        {spinning ? "Spinning..." : "Spin the Wheel"}
      </button>
      {result && (
        <div className="max-w-md w-full mb-4 bg-white p-6 rounded-lg shadow-md">
          <p className="text-2xl font-semibold mb-2">{result}</p>
